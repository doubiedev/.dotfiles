...
return {
    {
        ...
        keys = {
            ...
            { "<leader>odp", "<cmd>ObsidianToday -1<cr>",        desc = "Yesterday" },
            { "<leader>odn", "<cmd>ObsidianToday 1<cr>",         desc = "Tomorrow" },
            ...
            { "<leader>olt", "<cmd>ObsidianTags<cr>",            desc = "Tags" },
            { "<leader>olk", "<cmd>ObsidianLinks<cr>",           desc = "Links" },

            { "<leader>ot",  "<cmd>ObsidianTemplate<cr>",        desc = "Insert template" },
            { "<leader>otn", "<cmd>ObsidianNewFromTemplate<cr>", desc = "New from template" },
            { "<leader>otc", "<cmd>ObsidianTOC<cr>",             desc = "TOC" },
